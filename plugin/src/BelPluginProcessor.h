/*
 * BelPluginProcessor.h — the plugin itself.
 *
...
class BelAudioProcessor final : public juce::AudioProcessor {
public:
  BelAudioProcessor();
  ~BelAudioProcessor() override;
  ...
  const juce::String getName() const override { return "Bel"; }
...
private:
  ...
  JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(BelAudioProcessor)
};

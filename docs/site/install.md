...
```sh
chmod +x Open Audio Analyzer-0.1.0-x86_64.AppImage
./Open Audio Analyzer-0.1.0-x86_64.AppImage
```
...
```sh
flatpak install --user Open Audio Analyzer-0.1.0-x86_64.flatpak

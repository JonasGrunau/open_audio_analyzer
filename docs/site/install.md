...
```sh
tar -xzf Open.Audio.Analyzer-0.8.0-linux-x86_64.tar.gz
cd "Open Audio Analyzer-0.8.0-linux-x86_64"
./install.sh
```
...
```sh
chmod +x Open.Audio.Analyzer-0.8.0-x86_64.AppImage
./Open.Audio.Analyzer-0.8.0-x86_64.AppImage
```
...
```sh
flatpak install --user Open.Audio.Analyzer-0.8.0-x86_64.flatpak

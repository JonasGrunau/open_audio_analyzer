/// The Open Audio Analyzer design system.
///
...
///   3. Every control Open Audio Analyzer paints itself is built through [OaaFocusable]. A
...
export 'src/module_tap_group.dart';
export 'src/panel.dart';
export 'src/plot_border.dart';

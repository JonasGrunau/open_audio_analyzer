...
/// report is a plain object — and the other two are what make Bel usable from
/// a release pipeline, which is the point at which a metering tool stops being
/// something you look at and starts being something you can gate a build on.
enum ReportFormat {
  ...
  /// A filename for [report] in this format: `Rush (Live) — Bel report.txt`.
  String suggestedFileName(AnalysisReport report) {
    final stem = report.fileName.contains('.')
        ...
        : report.fileName;
    return '$stem — Bel report.$extension';
  }
}

...
/// What Bel remembers between launches.
///
...
///
/// This mirrors `BelSource` in `bel_engine` and deliberately is not it.
/// `bel_core` may not import `dart:ffi`, and the remote display persists a
...
/// The version stamped into every file Bel writes.
///
...
class AppSettings {
  ...
  ///
  /// On by default, and worth being able to turn off: somebody using Bel to
  /// check one file at a time wants the same clean default layout every time,
  /// and having yesterday's experiment restored is a small daily annoyance.
  ...
  factory AppSettings.fromJson(Map<String, Object?> json) {
    ...
    return AppSettings(
      ...
      remoteDisplayName: remoteName is String && remoteName.isNotEmpty
          ? remoteName
          : null,
      // Below 1024 needs privileges Bel does not have and should never ask
      // for; above 65535 is not a port.
      remoteDisplayPort:

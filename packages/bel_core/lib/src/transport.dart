...
///
/// This is domain vocabulary, not wire format — `bel_wire` decodes bytes into
...
///
/// It is deliberately **not** part of `bel_snapshot`. The engine measures audio
...
class Transport {
  ...
  ///
  /// Bel does not attempt to hide that by refusing to show a bar number: a
  /// number that is right in the ordinary case and stated to be approximate in
  /// the unusual one is more use than no number at all. It is, however, why
  /// nothing downstream should treat this as a measurement.
